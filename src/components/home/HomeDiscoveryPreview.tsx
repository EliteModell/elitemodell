  ...
  return (
    <section className="home-discovery">
      ...
      <style>{`
        ...
        .home-discovery-head span{color:#ca4651;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.12em}
        ...
        .home-discovery-head>a{flex:0 0 auto;color:#ca4651;font-weight:900;text-decoration:none}
        ...
        .home-profile-card{scroll-snap-align:start;overflow:hidden;border:1px solid rgba(202, 70, 81,.18);border-radius:16px;background:#0d0d0d;color:#f4f1ea;text-decoration:none;box-shadow:0 22px 64px rgba(0,0,0,.32);transition:.2s ease}
        .home-profile-card:hover{transform:translateY(-3px);border-color:rgba(202, 70, 81,.45)}
        ...
        .home-profile-badges span{border:1px solid rgba(202, 70, 81,.3);border-radius:999px;background:rgba(5,5,5,.78);padding:4px 8px;color:#f2c8cc;font-size:10px;font-weight:900}
        ...
        .home-profile-copy small{color:#ca4651}
        .home-profile-copy b{text-align:right;color:#f2c8cc;font-size:12px}
