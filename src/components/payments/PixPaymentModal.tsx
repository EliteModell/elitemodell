...
export default function PixPaymentModal({ planId, creditAmount, bookingId, amount, onClose, onSuccess }: Props) {
  ...
  const modal = (
    <div
      ...
      aria-modal="true"
    >
      <div className="payment-light-modal relative w-full max-w-[400px] overflow-hidden rounded-[24px] border border-[#b72cff]/25 bg-white shadow-[0_28px_90px_rgba(37, 31, 32,0.24)]">
