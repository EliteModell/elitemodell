...
export default function FiltersModal({ onClose, onApply }: Props) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 9000, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(4,10,20,0.92)", padding: 16, backdropFilter: "blur(6px)" }}>
      <div style={{ background: "#fff", color: "#141212", border: `1px solid ${GOLD_MID}`, borderRadius: 20, width: "100%", maxWidth: 820, maxHeight: "92vh", display: "flex", flexDirection: "column", overflow: "hidden", boxShadow: "0 32px 80px rgba(37, 31, 32,0.24)" }}>
        ...
        <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
          {/* Sidebar */}
          <div style={{ width: 190, borderRight: `1px solid ${GOLD_DIM}`, padding: "12px 0", overflowY: "auto", flexShrink: 0, background: "#080808" }}>
            {sections.map((s) => (
        ...
        {/* Footer */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 24px", borderTop: `1px solid ${GOLD_DIM}`, background: "#080808" }}>
          <button onClick={() => setFilters(defaultFilters)}
            ...
            onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = "#b4adb0")}
