    ...
    <div className="fixed inset-0 z-[950] grid place-items-center bg-black/80 p-4 backdrop-blur-xl" role="dialog" aria-modal="true" aria-labelledby="action-auth-title">
      <section className="w-full max-w-md rounded-2xl border border-[#b72cff]/30 bg-[linear-gradient(180deg,#15120d,#070707)] p-6 text-[#f4f1ea] shadow-[0_32px_100px_rgba(0,0,0,.7)]">
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <Link href={loginHref} className="grid min-h-12 place-items-center rounded-xl bg-[#b72cff] px-4 text-sm font-black text-black no-underline">
            Entrar
          </Link>
          <Link href={cadastroHref} className="grid min-h-12 place-items-center rounded-xl border border-[#b72cff]/35 bg-[#b72cff]/[.07] px-4 text-sm font-black text-[#e1a6ff] no-underline">
            Criar conta
          </Link>
        </div>
      </section>
