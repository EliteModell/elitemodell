  ...
  return (
    <section className="client-page min-h-[calc(100vh-220px)]">
      <p className="text-[13px] text-[#f5f0e4]/48">
        Página inicial <span className="mx-1">›</span> <strong className="text-[#e1a6ff]">Notificações</strong>
      </p>
      <div className="mt-8 border-t border-[#b72cff]/12 pt-7">
      ...
      <div className="client-empty mt-6 flex min-h-[380px] flex-col items-center justify-center px-5 py-10 text-center">
        <div className="relative">
          <span className="absolute -right-5 -top-5 h-28 w-28 rounded-full bg-[#b72cff]/12 blur-xl" />
          <Inbox className="relative h-32 w-32 stroke-[1.7] text-[#b72cff]" />
          <Bell className="absolute -right-1 top-2 h-9 w-9 text-[#e1a6ff]" />
        </div>
