      ...
      <div className="flex gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start gap-2">
            <h3 className="min-w-0 flex-1 text-[16px] font-bold leading-5 text-[#f5f0e4]">{title}</h3>
            <ChevronRight className="mt-0.5 h-4 w-4 shrink-0 text-[#f5d78c]" />
          </div>
          <p className="mt-1.5 text-[13px] leading-5 text-[#f5f0e4]/58">{text}</p>
          <p className="mt-2 text-[13px] font-semibold text-[#f5f0e4]">0 de {total} concluídos</p>
...
export default function AchievementsSection() {
  return (
    <section className="client-page-tight text-white">
      {/* Header */}
      <div className="client-panel mb-5 flex items-start gap-5 p-5">
        <div className="min-w-0 flex-1">
          <p className="client-kicker">Status privado</p>
          <h2 className="mt-1 text-[22px] font-bold text-white">Conquistas</h2>
      ...
      <button
        type="button"
        className="client-primary-button mt-5 w-full text-[15px] transition-opacity active:opacity-90"
      >
        Mostrar mais
      </button>
    </section>
