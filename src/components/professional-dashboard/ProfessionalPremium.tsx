  ...
  return (
    <style>{`
      :root {
        ...
        --elite-card-2: #181818;
        --elite-gold: #b72cff;
        --elite-gold-light: #e1a6ff;
        --elite-gold-dark: #65009b;
        --elite-text: #FFFFFF;
        --elite-text-muted: #B8B8B8;
        --elite-border: rgba(183, 44, 255,0.35);
        --elite-border-soft: rgba(183, 44, 255,0.18);
      ...
      .premium-profile-row {
        ...
        border-radius: 24px;
        background:
          radial-gradient(circle at 82% 18%, rgba(183, 44, 255,0.16), transparent 34%),
      ...
      .premium-profile-row::before {
        ...
        inset: 0 0 auto;
        height: 1px;
        background: linear-gradient(90deg, transparent, rgba(242, 200, 204,0.72), transparent);
        pointer-events: none;
        z-index: 0;
      }
      ...
      .premium-hero::after {
        ...
        height: 84%;
        background:
          radial-gradient(ellipse at center, rgba(242, 200, 204,0.20), rgba(183, 44, 255,0.08) 42%, transparent 70%);
        filter: blur(3px);
        pointer-events: none;
      }
      ...
      .premium-art-scene::before {
        ...
        border-radius: 999px;
        background:
          radial-gradient(circle at 50% 45%, rgba(242, 200, 204,0.28), rgba(183, 44, 255,0.10) 42%, transparent 72%);
        filter: blur(18px);
      }
      ...
      .premium-art-beam {
        ...
        background: linear-gradient(180deg, rgba(242, 200, 204,0.34), rgba(242, 200, 204,0.04) 62%, transparent);
        opacity: 0.7;
        filter: blur(2px);
      }
      ...
      .premium-art-floor {
        ...
        border-radius: 50%;
        background:
          radial-gradient(ellipse at center, rgba(242, 200, 204,0.34), rgba(183, 44, 255,0.10) 42%, transparent 72%);
        filter: blur(1px);
      }
      ...
      .premium-art-pedestal {
        ...
        background:
          linear-gradient(180deg, rgba(242, 200, 204,0.24), rgba(183, 44, 255,0.10) 45%, rgba(0,0,0,0.58)),
          linear-gradient(90deg, rgba(0,0,0,0.58), rgba(242, 200, 204,0.32), rgba(0,0,0,0.48));
      ...
      .premium-art-pedestal::before {
        ...
        background: linear-gradient(90deg, rgba(34,24,8,0.96), rgba(242, 200, 204,0.30), rgba(34,24,8,0.92));
      }
      ...
      .premium-art-bars i {
        ...
        bottom: 0;
        width: 18px;
        border: 1px solid rgba(242, 200, 204,0.46);
        border-radius: 8px 8px 2px 2px;
        background:
          linear-gradient(90deg, rgba(71,48,9,0.92), rgba(242, 200, 204,0.82), rgba(138,103,31,0.86));
        box-shadow: inset 0 1px 0 rgba(255,255,255,0.22), 0 0 20px rgba(183, 44, 255,0.20);
      }
      ...
      .premium-art-arrow::before {
        ...
        height: 5px;
        border-radius: 999px;
        background: linear-gradient(90deg, rgba(138,103,31,0.75), rgba(242, 200, 204,0.96));
        transform: rotate(-34deg);
        transform-origin: right center;
        box-shadow: 0 0 18px rgba(183, 44, 255,0.28);
      }
      ...
      .premium-art-arrow::after {
        ...
        filter: drop-shadow(0 0 14px rgba(183, 44, 255,0.38));
        transform: rotate(-34deg);
      }
      ...
      .premium-art-crown-shape {
        ...
        border: 1px solid rgba(242, 200, 204,0.48);
        box-shadow: inset 0 1px 0 rgba(255,255,255,0.36), 0 0 24px rgba(183, 44, 255,0.24);
      ...
      .premium-art-diamond-shape {
        ...
        background:
          linear-gradient(135deg, rgba(255,247,198,0.95), rgba(242, 200, 204,0.82) 38%, rgba(138,103,31,0.92) 72%, rgba(255,239,165,0.85));
        box-shadow: inset 0 0 18px rgba(255,255,255,0.18), 0 0 34px rgba(183, 44, 255,0.34);
      }
      ...
      .premium-art-camera-body::before {
        ...
        background: linear-gradient(135deg, rgba(242, 200, 204,0.32), rgba(0,0,0,0.40));
      }
      ...
      .premium-art-camera-lens {
        ...
        height: 44px;
        border-radius: 999px;
        border: 6px solid rgba(242, 200, 204,0.74);
        background:
        ...
        box-shadow: 0 0 22px rgba(183, 44, 255,0.26);
      }
      ...
      .premium-art-phone-card::before {
        ...
        height: 6px;
        border-radius: 999px;
        background: rgba(242, 200, 204,0.28);
      }
      ...
      .premium-art-phone-card::after {
        ...
        border-radius: 999px;
        background:
          radial-gradient(circle at center, rgba(242, 200, 204,0.62), rgba(183, 44, 255,0.18) 56%, transparent 58%);
      }
      ...
      .premium-art-photo-card::before {
        ...
        background: linear-gradient(135deg, rgba(242, 200, 204,0.80), rgba(138,103,31,0.62));
      }
      ...
      .premium-art-video-card::before {
        ...
        filter: drop-shadow(0 0 10px rgba(183, 44, 255,0.35));
      }
      ...
      .premium-art-profile-card {
        ...
        border-radius: 28px;
        background:
          radial-gradient(circle at 50% 34%, rgba(242, 200, 204,0.18), transparent 40%),
      ...
      .premium-art-profile-card::before {
        ...
        width: 48px;
        height: 48px;
        border: 5px solid rgba(242, 200, 204,0.78);
        border-radius: 999px;
      ...
      .premium-art-shield {
        ...
        background:
          ...
          linear-gradient(145deg, rgba(242, 200, 204,0.35), rgba(0,0,0,0));
      ...
      .premium-art-calendar-card {
        ...
        width: 152px;
        height: 134px;
        border: 1px solid rgba(242, 200, 204,0.36);
        border-radius: 22px;
        background:
          linear-gradient(180deg, rgba(183, 44, 255,0.20), rgba(183, 44, 255,0.05) 28%, rgba(8,8,8,0.96) 29%),
      ...
      .premium-art-calendar-card::before {
        ...
        bottom: 22px;
        background:
          radial-gradient(circle at 14px 14px, rgba(242, 200, 204,0.78) 0 4px, transparent 5px),
          radial-gradient(circle at 52px 14px, rgba(242, 200, 204,0.48) 0 4px, transparent 5px),
          radial-gradient(circle at 90px 14px, rgba(242, 200, 204,0.48) 0 4px, transparent 5px),
          radial-gradient(circle at 14px 48px, rgba(242, 200, 204,0.48) 0 4px, transparent 5px),
          radial-gradient(circle at 52px 48px, rgba(242, 200, 204,0.78) 0 4px, transparent 5px),
          radial-gradient(circle at 90px 48px, rgba(242, 200, 204,0.48) 0 4px, transparent 5px);
      }
      ...
      .premium-art-spark {
        ...
        box-shadow: 0 0 14px rgba(242, 200, 204,0.82);
      }
      ...
      .premium-action-card:hover {
        ...
        border-color: rgba(242, 200, 204,0.65);
        box-shadow: 0 16px 42px rgba(0,0,0,0.55), 0 0 24px rgba(183, 44, 255,0.12);
      }
      ...
      .premium-icon-orb {
        ...
        border-radius: 999px;
        background:
          radial-gradient(circle at 42% 34%, rgba(242, 200, 204,0.28), rgba(183, 44, 255,0.10) 44%, rgba(0,0,0,0.18) 68%),
          linear-gradient(145deg, rgba(183, 44, 255,0.14), rgba(0,0,0,0.35));
        color: var(--elite-gold-light);
        box-shadow: inset 0 1px 0 rgba(255,255,255,0.08), 0 0 28px rgba(183, 44, 255,0.12);
      }
      ...
      .premium-icon-orb::after {
        ...
        border: 1px solid rgba(242, 200, 204,0.16);
      }
      ...
      .premium-icon-orb svg {
        ...
        width: 36px;
        height: 36px;
        filter: drop-shadow(0 0 16px rgba(183, 44, 255,0.38));
      }
      ...
      .premium-button {
        ...
        background: linear-gradient(135deg, #e1a6ff 0%, #b72cff 48%, #8f1fd1 100%);
        color: #080808;
        box-shadow:
          0 10px 26px rgba(183, 44, 255,0.28),
      ...
      .premium-lower-card {
        ...
        background:
          radial-gradient(circle at top right, rgba(183, 44, 255,0.10), transparent 38%),
      ...
      .premium-lower-card::before {
        ...
        pointer-events: none;
        z-index: 0;
        background: linear-gradient(90deg, transparent, rgba(242, 200, 204,0.52), transparent);
      }
      ...
      .premium-plan-card.featured {
        border-color: rgba(242, 200, 204,0.75);
        box-shadow: 0 22px 70px rgba(0,0,0,0.50), 0 0 38px rgba(183, 44, 255,0.18);
      }
      ...
      .premium-avatar {
        ...
        place-items: center;
        overflow: hidden;
        box-shadow: 0 0 26px rgba(183, 44, 255,0.16);
      }
      ...
      .professional-bottom-nav {
        ...
        border-top: 1px solid rgba(183, 44, 255,0.25);
      ...
      .professional-bottom-nav a.active {
        border: 1px solid rgba(242, 200, 204,0.40);
        background: linear-gradient(145deg, rgba(183, 44, 255,0.26), rgba(12,10,6,0.94));
        color: var(--elite-gold-light);
        box-shadow: inset 0 1px 0 rgba(255,255,255,0.08), 0 10px 26px rgba(183, 44, 255,0.12);
      }
      ...
      /* Identidade clara 2026: mantém a estrutura e remove o cenário decorativo escuro. */
      :root {
        --elite-bg: #f7f7fa;
        ...
        --elite-card-2: #faf9fc;
        --elite-gold: #b72cff;
        --elite-gold-light: #b72cff;
        --elite-gold-dark: #8f1fd1;
        --elite-text: #141212;
      ...
      .premium-profile-row {
        ...
        box-shadow: 0 10px 30px rgba(37, 31, 32,.07) !important;
      }
      .premium-card::before,
      .premium-hero::before,
      .premium-section-card::before,
      .premium-plan-card::before,
      .premium-upload-zone::before,
      .premium-profile-row::before { display: none !important; }
      .premium-title,
      .premium-section-title,
      .premium-action-title { color: var(--elite-text) !important; font-family: var(--font-inter), Inter, "Segoe UI", sans-serif !important; }
      .premium-title { font-size: clamp(36px, 5vw, 56px) !important; line-height: 1.05 !important; }
      .premium-eyebrow { letter-spacing: .08em !important; text-transform: none !important; }
      .premium-description,
      ...
      .premium-icon-orb { width: 48px !important; height: 48px !important; border-color: #e7cbf5 !important; background: #faf0ff !important; color: #b72cff !important; box-shadow: none !important; }
      ...
      .premium-button { background: #b72cff !important; color: #fff !important; box-shadow: 0 10px 24px rgba(183, 44, 255,.2) !important; }
      .premium-button-secondary,
  ...
  return (
    <Link href={href} className="premium-profile-row">
      <span className="premium-avatar">
        {image ? <img src={image} alt={name} /> : <UserRound size={42} color="#e1a6ff" />}
