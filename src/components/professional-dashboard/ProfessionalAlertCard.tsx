...
const toneClass = {
  gold: "border-[#ca4651]/30 bg-[linear-gradient(135deg,rgba(202, 70, 81,0.13),rgba(255,255,255,0.035))] text-[#f2c8cc]",
          ...
          <div key={alert.id} className={`relative overflow-hidden rounded-[18px] border p-4 shadow-[0_18px_50px_rgba(0,0,0,0.22)] sm:p-5 ${toneClass[alert.tone]}`}>
            <div className="flex gap-3 pr-8 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <Link
                  href={alert.href}
                  className="professional-primary-action mt-4 inline-flex min-h-11 w-full max-w-[260px] items-center justify-center rounded-[12px] bg-[#ca4651] px-5 py-2.5 text-center text-sm font-black leading-5 text-[#080704] no-underline shadow-[0_14px_34px_rgba(202, 70, 81,0.20)] transition hover:bg-[#f2c8cc] sm:w-auto"
                >
                  {alert.actionLabel}
                </Link>
              </div>
