  ...
  return (
    <div className="age-gate" role="presentation">
      ...
      <style>{`
        ...
        .age-logo span {
          background: linear-gradient(135deg, #fcf7ff 0%, #b72cff 28%, #e1a6ff 55%, #65009b 100%);
        ...
        .adult-badge {
          ...
          min-height: 54px;
          margin: 0 auto 18px;
          border: 1px solid rgba(225, 166, 255, 0.58);
          border-radius: 999px;
        ...
        .deny-button:focus-visible {
          outline: 3px solid rgba(225, 166, 255, 0.46);
          outline-offset: 3px;
        }
        ...
        .continue-button {
          min-height: 58px;
          border: 0;
          background: linear-gradient(135deg, #e1a6ff, ${GOLD} 46%, #65009b);
          color: #070707;
          font-size: 15px;
          font-weight: 950;
