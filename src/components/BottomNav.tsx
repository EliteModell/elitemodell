...
export default function BottomNav() {
  ...
  const items = [
    ...
    },
    {
      href: "/buscar?tab=acompanhantes",
      label: "Acompanhantes",
      active: pathname === "/buscar" && typeof window !== "undefined" && window.location.search.includes("acompanhantes"),
      icon: (active: boolean) => (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? GOLD : "#475569"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      label: "Imóveis",
      active: pathname === "/buscar" && typeof window !== "undefined" && window.location.search.includes("imoveis"),
      icon: (active: boolean) => (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? GOLD : "#475569"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <>
      ...
      <div className="bottom-nav-spacer" style={{ height: 62 }} />
      <style>{`
