    ...
    <div className="premium-upsell-backdrop" role="dialog" aria-modal="true" aria-labelledby="premium-upsell-title">
      <style>{`
        ...
        .premium-upsell-panel {
          ...
          background: radial-gradient(circle at 50% -15%, rgba(183, 44, 255,.19), transparent 42%), linear-gradient(180deg,#080808,#070707 58%);
        ...
        .premium-upsell-primary {
          ...
          background: linear-gradient(135deg,#fcf7ff,#b72cff 48%,#65009b); color: #090704; font-weight: 950;
