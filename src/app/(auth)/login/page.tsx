...
const loginPageStyles = (
  <style>{`
        ...
        .secondary-cta {
          ...
          border: 0;
          border-radius: 18px;
          background: linear-gradient(135deg, #e1a6ff, #b72cff 45%, #65009b);
          color: #070707;
          display: inline-flex;
          align-items: center;
          justify-content: center;
        ...
        .auth-topbar button,
        .country-pill { border-color: #e1a6ff; background: #fff; color: #62687a; }
        ...
        .trust-section,
        .link-groups,
        .visibility-section { border-color: #fcf7ff; background: #fff; box-shadow: 0 12px 36px rgba(37, 31, 32,.08); }
