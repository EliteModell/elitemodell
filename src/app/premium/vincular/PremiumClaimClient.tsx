...
export default function PremiumClaimClient({ returnTo }: { returnTo: string }) {
  ...
  return (
    <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: 20, background: "radial-gradient(circle at 50% 0%,rgba(183, 44, 255,.15),transparent 38%),#050505", color: "#f4f1ea" }}>
      <section style={{ width: "min(460px,100%)", padding: 28, borderRadius: 22, border: "1px solid rgba(183, 44, 255,.3)", background: "linear-gradient(180deg,#080808,#080808)", textAlign: "center", boxShadow: "0 30px 90px rgba(0,0,0,.7)" }}>
        ...
        <p style={{ margin: "18px 0 7px", color: "#b72cff", fontSize: 11, fontWeight: 950, textTransform: "uppercase", letterSpacing: 2 }}>Elite Modell Premium</p>
        ...
        {status === "error" && (
          <Link href={returnTo} style={{ display: "grid", minHeight: 48, placeItems: "center", marginTop: 18, borderRadius: 12, background: "#b72cff", color: "#080704", fontWeight: 900, textDecoration: "none" }}>
