      ...
      {sections.map((section) => (
        ...
        >
          <summary className="flex cursor-pointer list-none items-start justify-between gap-3">
            ...
            <ChevronDown className="mt-0.5 h-4 w-4 shrink-0 text-[#f2c8cc] transition-transform group-open:rotate-180" />
          </summary>
          ...
          {section.href && (
            <Link
              href={section.href}
              className="mt-4 inline-block text-[13px] font-semibold text-[#f2c8cc] no-underline"
            >
              Ler completo →
            </Link>
          )}
