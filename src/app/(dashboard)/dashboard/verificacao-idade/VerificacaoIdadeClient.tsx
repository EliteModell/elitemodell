    ...
    <main className="client-page space-y-6">
      ...
      <section className="client-panel overflow-hidden p-6">
        <div className="flex items-start gap-4">
          <span className="grid h-16 w-16 shrink-0 place-items-center rounded-[8px] border border-[#b72cff]/25 bg-[#b72cff]/12 text-[#c451ff]">
            <ShieldCheck className="h-7 w-7" />
          </span>
          <div className="min-w-0">
            <span className="inline-flex rounded-full border border-[#b72cff]/25 bg-[#b72cff]/10 px-3 py-1 text-[12px] font-black uppercase text-[#c451ff]">
            ...
            <p className="mt-2 text-[12px] font-black text-[#c451ff]">
              {providerLabel}
            </p>
            {kycSessionId ? (
        ...
        {status === "pending" ? (
          <div className="mt-6 rounded-[18px] border border-[#b72cff]/20 bg-[#b72cff]/8 p-5 text-center">
            <p className="text-[15px] font-black text-[#c451ff]">Verificação em análise</p>
      ...
      <section className="client-card p-5">
        <div className="flex items-start gap-4">
          <span className="grid h-14 w-14 shrink-0 place-items-center rounded-[8px] border border-[#b72cff]/20 bg-[#b72cff]/10 text-[#c451ff]">
