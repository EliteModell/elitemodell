  ...
  return (
    <div className="flex gap-0.5">
      {[1, 2, 3, 4, 5].map((i) => (
        <Star
          key={i}
          className={`h-4 w-4 ${i <= Math.round(rating) ? "fill-[#b72cff] text-[#b72cff]" : "text-[#d0d7da]"}`}
        />
      ))}
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="mt-1 flex items-center gap-1">
        <Star className="h-3 w-3 fill-[#b72cff] text-[#b72cff]" />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="client-panel-soft p-4 text-center">
              <div className="flex items-center justify-center gap-1.5">
                <Star className="h-5 w-5 fill-[#b72cff] text-[#b72cff]" />
