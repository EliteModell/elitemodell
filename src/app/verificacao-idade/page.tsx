    ...
    <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#f7f7fa", color: "#17141d", padding: 24 }}>
      <section style={{ width: "min(560px,100%)", border: "1px solid rgba(183,44,255,.28)", borderRadius: 8, background: "#101012", padding: 30 }}>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginTop: 22 }}>
          <Link href="/login?returnUrl=%2Fdashboard%2Fverificacao-idade" style={{ background: "#7c22ee", color: "#fff", borderRadius: 10, padding: "13px 18px", textDecoration: "none", fontWeight: 900 }}>Entrar e verificar</Link>
