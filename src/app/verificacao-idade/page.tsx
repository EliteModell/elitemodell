...
export default function PublicAgeVerificationPage() {
  return (
    <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#050506", color: "#fff", padding: 24 }}>
      <section style={{ width: "min(560px,100%)", border: "1px solid rgba(183,44,255,.28)", borderRadius: 8, background: "#101012", padding: 30 }}>
        <p style={{ color: "#b72cff", fontWeight: 900, textTransform: "uppercase", fontSize: 12 }}>Conteudo restrito a adultos</p>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginTop: 22 }}>
          <Link href="/login?returnUrl=%2Fdashboard%2Fverificacao-idade" style={{ background: "#b72cff", color: "#080704", borderRadius: 8, padding: "13px 18px", textDecoration: "none", fontWeight: 900 }}>Entrar e verificar</Link>
