...
export function buildAuthEmail(payload: AuthEmailPayload): AuthEmail | null {
  ...
  const base = `
    <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;background:#0a0a0a;color:#f8f5fa;border:1px solid rgba(212,168,67,0.25);border-radius:12px;overflow:hidden">
      ...
      <div style="padding:40px 32px">
        <div style="margin-bottom:28px;text-align:center">
          <span style="font-weight:900;font-size:24px">
            <span style="background:linear-gradient(135deg,#f0d4ff,#b72cff,#e1a6ff);-webkit-background-clip:text;-webkit-text-fill-color:transparent">elite</span><span style="color:#f8f5fa">modell</span>
          </span>
        </div>
        CONTENT
  ...
  if (email_action_type === "signup") {
    ...
    return {
      ...
      html: base.replace("CONTENT", `
        <h2 style="color:#f8f5fa;font-size:22px;margin:0 0 12px">Confirme seu cadastro</h2>
        <p style="color:#b9adbf;line-height:1.7;margin:0">Clique no botao abaixo para ativar sua conta na Elite Modell.</p>
  ...
  if (email_action_type === "recovery") {
    ...
    return {
      ...
      html: base.replace("CONTENT", `
        <h2 style="color:#f8f5fa;font-size:22px;margin:0 0 12px">Redefinir senha</h2>
        <p style="color:#b9adbf;line-height:1.7;margin:0">Recebemos um pedido para redefinir a senha de <strong>${userEmail}</strong>.</p>
  ...
  if (email_action_type === "invite") {
    ...
    return {
      ...
      html: base.replace("CONTENT", `
        <h2 style="color:#f8f5fa;font-size:22px;margin:0 0 12px">Convite Elite Modell</h2>
        <p style="color:#b9adbf;line-height:1.7;margin:0">Voce recebeu um convite para criar sua conta na Elite Modell.</p>
  ...
  if (email_action_type === "email_change") {
    ...
    return {
      ...
      html: base.replace("CONTENT", `
        <h2 style="color:#f8f5fa;font-size:22px;margin:0 0 12px">Confirme seu novo e-mail</h2>
        <p style="color:#b9adbf;line-height:1.7;margin:0">Clique abaixo para confirmar a alteracao do seu endereco de e-mail.</p>
  ...
  if (email_action_type === "magiclink") {
    ...
    return {
      ...
      html: base.replace("CONTENT", `
        <h2 style="color:#f8f5fa;font-size:22px;margin:0 0 12px">Link de acesso</h2>
        <p style="color:#b9adbf;line-height:1.7;margin:0">Clique no botao abaixo para entrar na sua conta.</p>
  ...
  const base = `
    <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;background:#0a0a0a;color:#f8f5fa;border:1px solid rgba(212,168,67,0.25);border-radius:12px;overflow:hidden">
      ...
      <div style="padding:40px 32px">
        ...
        <h2 style="color:#f8f5fa;font-size:22px;margin:0 0 12px">Cadastro aprovado</h2>
        <p style="color:#b9adbf;line-height:1.7;margin:0">Olá,</p>
        <p style="color:#b9adbf;line-height:1.7;margin:12px 0">Seu cadastro na Elite Modell foi aprovado.</p>
        <p style="color:#b9adbf;line-height:1.7;margin:0">Seu perfil já pode ficar disponível na plataforma conforme as regras de segurança e moderação.</p>
        <p style="color:#b9adbf;line-height:1.7;margin:24px 0 0">Atenciosamente,<br><strong style="color:#f8f5fa">Equipe Elite Modell</strong></p>
        <div style="margin-top:32px;padding-top:20px;border-top:1px solid rgba(255,255,255,0.08);text-align:center;color:#aaa0b2;font-size:12px">
          Elite Modell - Plataforma premium adulta - Brasil
        </div>
      </div>
